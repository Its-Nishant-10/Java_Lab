...
public class as_9_q_18 {
    public static void main(String[] args) {
        ...
        if (f.exists()) System.out.println("File is present");
        ...
        if (f.canWrite()) System.out.println("File can be written");
        else System.out.println("File can't be written");
    }
}